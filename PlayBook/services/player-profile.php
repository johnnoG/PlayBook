...
// Fetch number of different fields played and number of games played
$sql = "SELECT COUNT(DISTINCT fieldLocation) as different_fields_played FROM PlayerFieldContact WHERE PlayerEmail = ?";
$stmt = $conn->prepare($sql);
if (!$stmt) {
    die("Prepare statement failed: " . $conn->error);
}
...
$different_fields_played = $row['different_fields_played'];
$stmt->close();

$sql = "SELECT COUNT(*) as games_played FROM PlayerFieldContact WHERE PlayerEmail = ?";
$stmt = $conn->prepare($sql);
if (!$stmt) {
    die("Prepare statement failed: " . $conn->error);
}
...
<body>
    <nav>
        <div class="containerNav">
            ...
            <div><a href="#" onclick="navigateToPage('../services/player-profile.php')">Profile</a></div>
                ...
                <div class="col-lg-6">
                    <div class="about-text go-to">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="view-mode">Full Name:<?php echo htmlspecialchars($user['FullName'] ?? ''); ?></div>
                ...
                <div class="row">
                    <div class="col-6 col-lg-3">
                        <div class="count-data text-center">
                            <h6 class="count h2" id="played"><?php echo htmlspecialchars($games_played); ?></h6>
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="count-data text-center">
                            <h6 class="count h2" id="fields"><?php echo htmlspecialchars($different_fields_played); ?></h6>
                            <p class="m-0px font-w-600">Different Fields</p>
                        </div>
                    </div>
                </div>
            </div>
