    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $fieldUrls = [
                    "Jerusalem_david_21" => "Book_Game_Jerusalem/Jerusalem_david_21.php",
                    "Jerusalem_Hertzog_54" => "Book_Game_Jerusalem/Jerusalem_Hertzog_54.php",
                    "Jerusalem_Kadesh_33" => "Book_Game_Jerusalem/Jerusalem_Kadesh_33.php",
                    "Jerusalem_Rabin_33" => "Book_Game_Jerusalem/Jerusalem_Rabin_33.php"
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7'>No soccer fields found in Jerusalem</td></tr>";
                }
