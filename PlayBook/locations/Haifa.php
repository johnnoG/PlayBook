    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $fieldUrls = [
                    "Haifa_Habrzel_64" => "Book_Game_Haifa/Haifa_Habrzel_64.php",
                    "Haifa_Hagefen_7" => "Book_Game_Haifa/Haifa_Hagefen_7.php",
                    "Haifa_Hertzel_13" => "Book_Game_Haifa/Haifa_Hertzel_13.php",
                    "Haifa_Rabin_5" => "Book_Game_Haifa/Haifa_Rabin_5.php"
                    // Add more as needed
                ];
