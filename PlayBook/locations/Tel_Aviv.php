    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $fieldUrls = [
                    "Tel_Aviv_Rothiled_22" => "Book_Game_TelAviv/Tel_Aviv_Rothiled_22.php",
                    "Tel_Aviv_Remez_34" => "Book_Game_TelAviv/Tel_Aviv_Remez_34.php",
                    "Tel_Aviv_itzhak_sade_56" => "Book_Game_TelAviv/Tel_Aviv_itzhak_sade_56.php",
                    "Tel_Aviv_frishman_54" => "Book_Game_TelAviv/Tel_Aviv_frishman_54.php"
                    // Add more as needed
                ];
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7'>No soccer fields found in Tel Aviv </td></tr>";
                }
